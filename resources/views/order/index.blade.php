                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="quantity__item"><span class="quantity">{{Carbon\Carbon::parse($orders->created_at)->isoFormat('YYYY-MM-DD')}}</span></td>
                                <td></td>
                                ...
                                <td class="quantity__item">
                                    ...
                                    @if($orders->status === 1)
                                        <a class="btn btn-info btn-sm" onclick="return window.confirm('Bạn có chắc chắn muốn hủy đơn hàng?')" href="{{route('order-bill-destroy',parameters: ['id'=>$orders->id_order])}}" >
